...
export default function Home() {
  ...
  const tools: Tool[] = [
    {
      name: "Sunting PDF",
      desc: "Tambahkan tulisan, sorotan, dan bentuk langsung di atas halaman PDF Anda.",
      href: "/edit-pdf",
      icon: Pencil,
    ...
    {
      name: "Formulir PDF",
      desc: "Isi formulir PDF langsung dari browser, lalu kunci isiannya bila sudah final.",
      href: "/pdf-forms",
    ...
    {
      name: "Sensor PDF",
      desc: "Hapus permanen nama, nomor, atau kata sensitif sebelum dokumen dibagikan.",
      href: "/redact-pdf",
      icon: EyeOff,
    ...
    {
      name: "Pindai ke PDF",
      desc: "Foto dokumen lewat kamera dan susun semuanya jadi satu berkas PDF.",
      href: "/scan-to-pdf",
      icon: ScanLine,
    ...
    {
      name: "Putar PDF",
      desc: "Betulkan halaman yang terbalik atau miring, seluruhnya atau sebagian.",
      href: "/rotate-pdf",
      icon: RotateCw,
    ...
    {
      name: "Hapus Halaman",
      desc: "Buang halaman kosong atau lembar yang tidak diperlukan dari sebuah PDF.",
      href: "/remove-pages",
      icon: FileMinus,
      color: "text-blue-600 dark:text-blue-400",
      bg: "bg-blue-50 dark:bg-blue-900/30",
    ...
    {
      name: "Ambil Halaman",
      desc: "Petik halaman tertentu menjadi PDF baru tanpa mengubah dokumen aslinya.",
      href: "/extract-pages",
      icon: FileOutput,
      color: "text-emerald-600 dark:text-emerald-400",
      bg: "bg-emerald-50 dark:bg-emerald-900/30",
    ...
    {
      name: "OCR PDF",
      desc: "Ubah PDF hasil pindaian jadi PDF yang teksnya bisa dicari dan disalin, tanpa mengubah tampilannya.",
      href: "/ocr-pdf",
      icon: ScanText,
      color: "text-violet-600 dark:text-violet-400",
      bg: "bg-violet-50 dark:bg-violet-900/30",
    ...
    {
      name: "Tanda Air PDF",
      desc: "Bubuhkan tanda air teks secara diagonal, berulang, atau di tepi halaman.",
      href: "/watermark-pdf",
      icon: Droplets,
    ...
    {
      name: "Nomor Halaman",
      desc: "Tambahkan nomor halaman dengan posisi, format, dan ukuran yang bisa diatur.",
      href: "/page-numbers",
      icon: Hash,
      color: "text-emerald-600 dark:text-emerald-400",
      bg: "bg-emerald-50 dark:bg-emerald-900/30",
    ...
    {
      name: "Pangkas PDF",
      desc: "Buang margin kosong di sekeliling halaman, otomatis mengikuti isi atau sesuai ukuran Anda.",
      href: "/crop-pdf",
      icon: Crop,
    ...
    {
      name: "Bandingkan PDF",
      desc: "Lihat baris yang ditambah dan dihapus antara dua versi dokumen, dirangkum jadi laporan PDF.",
      href: "/compare-pdf",
      icon: GitCompare,
      color: "text-amber-600 dark:text-amber-400",
      bg: "bg-amber-50 dark:bg-amber-900/30",
    ...
    {
      name: "Perbaiki PDF",
      desc: "Bangun ulang PDF yang rusak atau tidak mau dibuka, sekalian dipadatkan.",
      href: "/repair-pdf",
      icon: Wrench,
    ...
    {
      name: "Excel to PDF",
      desc: "Ubah lembar kerja Excel, ODS, atau CSV menjadi PDF rapi tanpa kolom yang terpotong.",
      href: "/excel-to-pdf",
      icon: Sheet,
      color: "text-emerald-600 dark:text-emerald-400",
      bg: "bg-emerald-50 dark:bg-emerald-900/30",
    ...
    },
    {
      ...
      desc: "Ubah tiap halaman PDF menjadi satu slide PPTX yang siap dipresentasikan.",
    ...
    {
      name: "PDF to PNG",
      desc: "Ubah halaman PDF menjadi PNG tanpa kompresi lossy, tajam untuk diagram dan teks.",
      href: "/pdf-to-png",
      icon: FileImage,
      color: "text-violet-600 dark:text-violet-400",
      bg: "bg-violet-50 dark:bg-violet-900/30",
    ...
    {
      name: "PDF to CSV",
      desc: "Ambil tabel dari PDF sebagai CSV yang siap diimpor ke alat analisis mana pun.",
      href: "/pdf-to-csv",
      icon: Table,
      color: "text-emerald-600 dark:text-emerald-400",
      bg: "bg-emerald-50 dark:bg-emerald-900/30",
    ...
    {
      name: "PDF to Teks",
      desc: "Ambil seluruh isi tulisan dari PDF sebagai teks polos atau Markdown.",
      href: "/pdf-to-text",
      icon: Type,
      color: "text-sky-600 dark:text-sky-400",
      bg: "bg-sky-50 dark:bg-sky-900/30",
    ...
    {
      name: "PDF to HTML",
      desc: "Ubah PDF menjadi satu halaman HTML yang bisa langsung dibuka di browser.",
      href: "/pdf-to-html",
      icon: Braces,
      color: "text-indigo-600 dark:text-indigo-400",
      bg: "bg-indigo-50 dark:bg-indigo-900/30",
    ...
    {
      name: "PDF to EPUB",
      desc: "Ubah PDF menjadi e-book dengan teks mengalir yang nyaman dibaca di ponsel.",
      href: "/pdf-to-epub",
      icon: BookOpen,
      color: "text-violet-600 dark:text-violet-400",
      bg: "bg-violet-50 dark:bg-violet-900/30",
    ...
    {
      name: "PDF to PDF/A",
      desc: "Jadikan PDF memenuhi standar arsip agar tetap terbaca sama puluhan tahun ke depan.",
      href: "/pdf-to-pdfa",
      icon: Archive,
      color: "text-blue-600 dark:text-blue-400",
      bg: "bg-blue-50 dark:bg-blue-900/30",
    ...
    {
      name: "Teks to PDF",
      desc: "Ubah berkas teks polos, RTF, atau ODT menjadi PDF yang siap dibagikan.",
      href: "/txt-to-pdf",
      icon: AlignLeft,
      color: "text-blue-600 dark:text-blue-400",
      bg: "bg-blue-50 dark:bg-blue-900/30",
    ...
    },
    {
      ...
      desc: "Ubah catatan Markdown menjadi PDF lengkap dengan heading, tabel, dan blok kode.",
    ...
    {
      name: "HTML to PDF",
      desc: "Ubah berkas HTML menjadi PDF dengan gaya dan tata letak yang ikut dirender.",
      href: "/html-to-pdf",
      icon: Code2,
      color: "text-indigo-600 dark:text-indigo-400",
      bg: "bg-indigo-50 dark:bg-indigo-900/30",
    ...
    {
      name: "EPUB to PDF",
      desc: "Ubah e-book EPUB menjadi PDF supaya bisa dibaca dan dicetak di mana saja.",
      href: "/epub-to-pdf",
      icon: BookOpen,
      color: "text-violet-600 dark:text-violet-400",
      bg: "bg-violet-50 dark:bg-violet-900/30",
