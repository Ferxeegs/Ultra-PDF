...
import { ShieldCheck, FileText, Lock, MousePointer2 } from "lucide-react";
...
export default function MergePage() {
  ...
  const addFiles = async (files: File[]) => {
    ...
    if (pdfFiles.length < 2) {
      alert("Minimal 2 file PDF untuk merge");
      return;
    }
    ...
    try {
      ...
      for (const entry of saved) {
        ...
        sessionStorage.setItem(`pdf-merge-${entry.id}`, JSON.stringify(fileMetadata));
      }
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-lg font-medium leading-relaxed max-w-xl mx-auto">
            Gabungkan beberapa file PDF menjadi satu dokumen dengan urutan sesuai keinginan. 
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 mb-1">Gabungkan PDF</h4>
            <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">Susun ulang urutan file dengan drag & drop untuk hasil yang sempurna.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">Drag, drop, dan atur urutan file sesuai keinginan Anda.</p>
          </div>
        </div>
