  ...
  return (
    <div className="mb-6">
      <div className="flex justify-between items-center text-xs font-bold text-blue-600 dark:text-blue-400 mb-3">
        ...
        <span className="px-2.5 py-1 bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 rounded-full">
          {progress}%
        </span>
      </div>
      <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-3 overflow-hidden">
        <div
          className="bg-gradient-to-r from-blue-500 dark:from-blue-600 to-indigo-600 dark:to-indigo-700 h-3 rounded-full transition-all duration-300 ease-out shadow-sm"
