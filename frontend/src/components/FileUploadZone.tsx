  ...
  return (
    <div className="p-8 border-b border-slate-100 dark:border-slate-700">
      <div
        ...
        onDrop={onDrop}
        className={`group relative flex flex-col items-center justify-center w-full h-40 border-2 border-dashed rounded-2xl cursor-pointer transition-all duration-300 ${isDragging
      ...
      >
        <label className="flex flex-col items-center justify-center w-full h-full cursor-pointer">
          <div className="flex flex-col items-center justify-center space-y-3">
            <div
              className={`p-4 rounded-full transition-all duration-300 ${isDragging
            ...
            >
              <FilePlus
                className={`w-10 h-10 transition-all duration-300 ${isDragging
            ...
            <div className="text-center px-4">
              <p
                className={`text-sm font-medium transition-colors duration-300 ${isDragging
              ...
              >
                {isDragging
                  ...
                  : label || (multiple ? "Tarik dan lepas file di sini" : "Tarik dan lepas file di sini")}
              </p>
          ...
          <input
            ...
            type="file"
            multiple={multiple}
            accept={accept} // Menggunakan properti accept yang dinamis
            className="hidden"
